...
<div class="container">
    <br>
    <h2 align="center"><img src="/menu/2.png"> Registrando valor inicial de caixa</h2>
    <br>
    <hr>
    <form class="" action="/caixa/registrar_fluxo" method="post" enctype="multipart/form-data">

        @csrf
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="instagram"><img src="/icons/real.png"> Valor inicial:</label>
