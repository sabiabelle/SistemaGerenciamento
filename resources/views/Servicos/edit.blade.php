...
<div class="container">
    <br>
    <h2 align="center"><img src="/menu/7.png"> Atualizando dados do serviço</h2>
    <br>
    <div class="alerts">
        @if ($errors->any())
    ...
    <hr>
    <form class="" action="/servicos/{{$servicos->id}}/update" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input class="form-control" type="text" require name="descricao" id="descricao" value="{{$servicos->descricao}}"
                    placeholder="">
            </div>
            <div class="form-group col-md-4">
            <label for="descricao"><img src="/icons/real.png"> Valor:</label>
                <div class="input-group-prepend">
                    ...
                    <input class="form-control" type="text" name="valor" id="valor" value="{{$servicos->valor}}"
                        placeholder="">
                </div>
            </div>
