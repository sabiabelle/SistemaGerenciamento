...
<div class="container">
    <br>
    <h2 align="center"><img src="/menu/7.png"> Registro de Serviços </h2>
    <br>
    <div class="alerts">
        @if (session('success'))
    ...
    <form name="buscar" method="GET" action="/servicos/">
        <div class="form-row">
            <div class="col">
            ...
            <div class="col">
                ...
                <a href="/servicos/create" class="btn btn-success" style="padding-right: 20px;">
    ...
    <table class="table table-responsive-lg">
        ...
        <tr class="table-light">
            ...
            <td>
                <a href="/servicos/{{$s->id}}/edit" class="btn btn-vaninha">
            ...
            <td>
                <a href="/servicos/{{$s->id}}/destroy" class="btn btn-danger">
