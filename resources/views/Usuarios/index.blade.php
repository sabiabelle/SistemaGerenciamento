...
<div class="container">
    <br>
    <h2 align="center"><img src="/menu/9.png"> Funcionários </h2>
    <br>
    <div class="alerts">
        @if (session('success'))
    ...
    <form name="buscar" method="GET" action="/users/">
        <div class="form-row">
            <div class="col">
                <input type="text" name="busca" class="form-control" placeholder="Encontrar usuarios...">
            </div>
            ...
            <div class="col">
                ...
                <a href="/usuarios/create" class="btn btn-success" style="padding-right: 20px;">
    ...
    <table class="table table-responsive-lg">
        <thead class="table table-dark">
            <tr>
                ...
                <th><b> Nova permissão</b></th>
        </thead>

        @foreach($user as $us)
        @if($us->id != $usuario_logado->id)
        <tr class="table-light">
            ...
            <td>
                <a href="/usuarios/{{$us->id}}/edit" class="btn btn-vaninha">
                ...
                <a href="/usuarios/{{$us->id}}/destroy" class="btn btn-danger">
